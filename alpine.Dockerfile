...
RUN apk upgrade &&\
    apk add --no-cache vim bash go python2 python2-dev python3 python3-dev py3-pip nodejs yarn npm dumb-init openssl musl-dev git perl-parallel-forkmanager perl &&\
