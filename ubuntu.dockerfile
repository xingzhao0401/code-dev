...
apt-get install -y wget build-essential pkg-config libssl-dev software-properties-common language-pack-zh-hans git openjdk-8-jdk &&\
...
dpkg -i code-server_3.10.2_amd64.deb && cd .. && rm -rf mwget_0.1.0.orig &&\
